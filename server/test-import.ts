/**
 * test-import.ts — Test the Python importer with example data
 * 
 * Creates a test campaign and imports final_leads.json
 * Run with: npx tsx server/test-import.ts
 */

import { importResultsFromPythonOutput } from "./pythonImporter";
import { createCampaign, getLeadsByCampaign, getAuditResultsByCampaign } from "./db";
